...
async def check_joined(update, context):
    ...
    f"👨‍💻 <b>ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ</b> @VISWAJEETHU",
        ...
        try:
            ...
            pass               
        await context.bot.send_message(query.message.chat_id,"<b>ᴊᴏɪɴ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ʀᴇǫᴜɪʀᴇᴅ</b>\n\nᴛᴏ ᴜsᴇ ᴛʜɪs ʙᴏᴛ, ʏᴏᴜ ᴍᴜsᴛ ᴊᴏɪɴ ᴛʜᴇ ғᴏʟʟᴏᴡɪɴɢ ᴄʜᴀɴɴᴇʟ ғɪʀsᴛ:\n\n<b> • Ꮮᴇᴀᴅᴇʀ Updates ✞</b>\n\nᴀғᴛᴇʀ ᴊᴏɪɴɪɴɢ, ᴄʟɪᴄᴋ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ᴠᴇʀɪғʏ:", parse_mode="HTML", reply_markup=InlineKeyboardMarkup(kb))
...
def run_bot():
    ...
    app_bot.add_handler(CallbackQueryHandler(check_joined, pattern="check_joined"))
